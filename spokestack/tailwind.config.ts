  ...
  theme: {
  	extend: {
  		...
  		borderRadius: {
  			...
  			// LMTD radius tokens
  			'ltd-sm': 'var(--ltd-radius-sm)',
  			'ltd-md': 'var(--ltd-radius-md)',
  			'ltd-lg': 'var(--ltd-radius-lg)',
  			'ltd-xl': 'var(--ltd-radius-xl)',
  		},
  		spacing: {
  			// LMTD density tokens
  			'ltd-control-height': 'var(--ltd-density-control-height)',
  			'ltd-control-px': 'var(--ltd-density-control-paddingX)',
  			'ltd-control-py': 'var(--ltd-density-control-paddingY)',
  			'ltd-control-gap': 'var(--ltd-density-control-gap)',
  			'ltd-table-row': 'var(--ltd-density-table-row)',
  			'ltd-card-padding': 'var(--ltd-density-card-padding)',
  			'ltd-page-padding': 'var(--ltd-density-page-padding)',
  		},
  	}
  },
