...
const API_CATEGORIES: ApiCategory[] = [
  ...
  },
  {
    ...
    description: "Rich text documents with Google Docs sync",
    icon: FileText,
    endpoints: [
      { method: "GET", path: "/api/v1/studio/documents", description: "List documents with filtering" },
      { method: "POST", path: "/api/v1/studio/documents", description: "Create a new document", requestBody: '{ "title": "...", "type": "SCRIPT", "clientId": "..." }' },
      { method: "GET", path: "/api/v1/studio/documents/:id", description: "Get document with versions" },
      { method: "PATCH", path: "/api/v1/studio/documents/:id", description: "Update document content" },
      { method: "DELETE", path: "/api/v1/studio/documents/:id", description: "Delete document" },
      { method: "POST", path: "/api/v1/studio/documents/:id/sync", description: "Sync to Google Docs" },
      { method: "GET", path: "/api/v1/studio/documents/:id/versions", description: "Get version history" },
      { method: "POST", path: "/api/v1/studio/documents/:id/restore", description: "Restore a previous version" },
    ],
  },
  {
    title: "Video Projects",
    description: "Video production management with scripts and storyboards",
    icon: Video,
    endpoints: [
      { method: "GET", path: "/api/v1/studio/video", description: "List video projects" },
      { method: "POST", path: "/api/v1/studio/video", description: "Create video project", requestBody: '{ "title": "...", "type": "SHORT_FORM", "clientId": "..." }' },
      { method: "GET", path: "/api/v1/studio/video/:id", description: "Get project with script, storyboard, shots" },
      { method: "PATCH", path: "/api/v1/studio/video/:id", description: "Update project details" },
      { method: "DELETE", path: "/api/v1/studio/video/:id", description: "Delete project" },
      { method: "PATCH", path: "/api/v1/studio/video/:id/script", description: "Update video script" },
      { method: "GET", path: "/api/v1/studio/video/:id/storyboard", description: "Get storyboard frames" },
      { method: "POST", path: "/api/v1/studio/video/:id/storyboard", description: "Add storyboard frame" },
      { method: "GET", path: "/api/v1/studio/video/:id/shots", description: "Get shot list" },
      { method: "POST", path: "/api/v1/studio/video/:id/shots", description: "Add shot to list" },
    ],
  },
  {
    title: "Pitch Decks",
    description: "Presentation builder with AI content generation",
    icon: Presentation,
    endpoints: [
      { method: "GET", path: "/api/v1/studio/decks", description: "List pitch decks" },
      { method: "POST", path: "/api/v1/studio/decks", description: "Create deck", requestBody: '{ "title": "...", "type": "PITCH", "clientId": "..." }' },
      { method: "GET", path: "/api/v1/studio/decks/:id", description: "Get deck with slides" },
      { method: "PATCH", path: "/api/v1/studio/decks/:id", description: "Update deck details" },
      { method: "DELETE", path: "/api/v1/studio/decks/:id", description: "Delete deck" },
      { method: "GET", path: "/api/v1/studio/decks/:id/slides", description: "Get slides" },
      { method: "POST", path: "/api/v1/studio/decks/:id/slides", description: "Add slide" },
      { method: "PATCH", path: "/api/v1/studio/decks/:id/slides/:slideId", description: "Update slide content" },
      { method: "DELETE", path: "/api/v1/studio/decks/:id/slides/:slideId", description: "Remove slide" },
      { method: "POST", path: "/api/v1/studio/decks/:id/reorder", description: "Reorder slides" },
    ],
  },
  {
    title: "Moodboards",
    description: "Visual inspiration with AI indexing and generation",
    icon: ImageIcon,
    endpoints: [
      { method: "GET", path: "/api/v1/studio/moodboards", description: "List moodboards" },
      { method: "POST", path: "/api/v1/studio/moodboards", description: "Create moodboard", requestBody: '{ "title": "...", "type": "BRAND", "clientId": "..." }' },
      { method: "GET", path: "/api/v1/studio/moodboards/:id", description: "Get moodboard with items" },
      { method: "PATCH", path: "/api/v1/studio/moodboards/:id", description: "Update moodboard" },
      { method: "DELETE", path: "/api/v1/studio/moodboards/:id", description: "Delete moodboard" },
      { method: "POST", path: "/api/v1/studio/moodboards/:id/items", description: "Add item (image, link, text, color)" },
      { method: "PATCH", path: "/api/v1/studio/moodboards/:id/items/:itemId", description: "Update item position/content" },
      { method: "DELETE", path: "/api/v1/studio/moodboards/:id/items/:itemId", description: "Remove item" },
      { method: "POST", path: "/api/v1/studio/moodboards/:id/generate", description: "Generate content from moodboard" },
    ],
  },
  {
    ...
    icon: Calendar,
    endpoints: [
      { method: "GET", path: "/api/v1/studio/calendar", description: "Get calendar entries for date range" },
      { method: "POST", path: "/api/v1/studio/calendar", description: "Create calendar entry", requestBody: '{ "title": "...", "contentType": "POST", "platforms": ["instagram"], "scheduledDate": "..." }' },
      { method: "GET", path: "/api/v1/studio/calendar/:id", description: "Get entry details" },
      { method: "PATCH", path: "/api/v1/studio/calendar/:id", description: "Update entry" },
      { method: "DELETE", path: "/api/v1/studio/calendar/:id", description: "Delete entry" },
      { method: "PATCH", path: "/api/v1/studio/calendar/:id/status", description: "Update entry status" },
    ],
  },
  {
    title: "AI Skills",
    description: "Pre-built AI assistants for creative tasks",
    icon: Sparkles,
    endpoints: [
      { method: "GET", path: "/api/v1/studio/skills", description: "List available AI skills" },
      { method: "GET", path: "/api/v1/studio/skills/:id", description: "Get skill details and inputs" },
      { method: "POST", path: "/api/v1/studio/skills/:id/execute", description: "Execute skill with inputs", requestBody: '{ "prompt": "...", "clientId": "...", "options": {...} }' },
...
const WEBHOOK_EVENTS = [
  ...
  { event: "studio.document.created", description: "New Studio document created" },
  { event: "studio.document.updated", description: "Studio document updated" },
  { event: "studio.document.synced", description: "Document synced with Google" },
  { event: "studio.video.created", description: "New video project created" },
  { event: "studio.video.status_changed", description: "Video project status changed" },
  { event: "studio.deck.created", description: "New pitch deck created" },
  { event: "studio.moodboard.created", description: "New moodboard created" },
  { event: "studio.moodboard.item_added", description: "Item added to moodboard" },
